...
<div class="w-full max-w-xl">
  <h2 class="text-xl md:text-2xl font-bold text-blue-900 mb-5 font-fredoka border-b border-gray-100 pb-4">{$t('settAccountTitle')}</h2>
  ...
  <div class="bg-blue-50/50 rounded-2xl p-4 md:p-6 border border-blue-100 mb-4">
    <div class="flex items-start gap-3">
      ...
      <div class="flex-1 min-w-0">
        ...
        <p class="text-slate-500 text-xs md:text-sm mb-3">{$t('settEmailDesc')}</p>
  ...
  <div class="bg-gray-50 rounded-2xl p-4 md:p-6 border border-gray-100 mb-6">
    <div class="flex items-start gap-3">
      ...
      <div class="flex-1 min-w-0">
        ...
        <p class="text-slate-500 text-xs md:text-sm mb-4">{$t('settLangDesc')}</p>
        ...
        <p class="text-[11px] text-gray-400 mt-2.5 italic">{$t('settLangSaved')}</p>
      </div>
    </div>
  </div>
  ...
  <div>
    ...
    <div class="border border-red-200 rounded-2xl p-4 md:p-6 bg-red-50/30">
      <h4 class="font-bold text-slate-800 mb-1 text-sm md:text-base">{$t('settDangerTitle')}</h4>
      <p class="text-slate-500 text-xs md:text-sm mb-4">{$t('settDangerDesc')}</p>
      <button
