              ...
              {#if lastRead.id}
                  ...
                  <div class="relative z-10 flex flex-col justify-between h-full">
                      ...
                      <div class="mt-8 flex items-end justify-between gap-6">
                          ...
                          <button onclick={() => window.location.href = `/read/${lastRead.id}`} class="bg-white text-blue-600 w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-transform shrink-0">
